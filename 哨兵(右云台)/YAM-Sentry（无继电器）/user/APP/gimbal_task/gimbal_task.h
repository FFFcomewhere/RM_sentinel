...
#define YAW_SPEED_PID_KP 45.0f  //32
...
//pitch 速度环 PID参数以及 PID最大输出，积分输出
#define PITCH_GYRO_SPEED_PID_KP 1000.0f   //5500
#define PITCH_GYRO_SPEED_PID_KI 0.3f       //1.8
#define PITCH_GYRO_SPEED_PID_KD 0.5f      //0.9

#define PITCH_GYRO_SPEED_PID_MAX_OUT 30000.0f
#define PITCH_GYRO_SPEED_PID_MAX_IOUT 5000.0f

//yaw 速度环 PID参数以及 PID最大输出，积分输出
#define YAW_GYRO_SPEED_PID_KP 45.0f  //32
#define YAW_GYRO_SPEED_PID_KI 0.3f
#define YAW_GYRO_SPEED_PID_KD 1.7f
...
#define PITCH_GYRO_ABSOLUTE_PID_KI 0.15f
...
#define YAW_ENCODE_RELATIVE_PID_KP 3000.0f
...
#define min_pitch_relative_angle    -PI/5

#define auto_pitch_up               0.3f
#define auto_pitch_down             -PI/5
#define auto_yaw_ccw                -PI/6
#define auto_yaw_cw                 -2*PI/3
